          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 12,
                children: [
                  for (final member in group.members) _StaffChip(member: member),
                ],
              ),
            ],
          ),
        ...
        if (!segment.isLink)
          ...
          TextSpan(
            ...
            style: const TextStyle(
              ...
              decorationColor: Color(0xFFB31B34),
            ),
  ...
  Widget build(BuildContext context) => Card(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(icon, color: const Color(0xFFB31B34), size: 28),
                ...
                const Icon(Icons.open_in_new, color: Color(0xFF98A2B3)),
              ],
            ),
          ),
        ),
